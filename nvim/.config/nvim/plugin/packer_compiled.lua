...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
    url = "https://github.com/hrsh7th/cmp-vsnip"
  },
  ["gruvbox-material"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/gruvbox-material",
  ...
  ["neo-tree.nvim"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/neo-tree.nvim",
    url = "https://github.com/nvim-neo-tree/neo-tree.nvim"
  },
  ["nui.nvim"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/nui.nvim",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/vim-commentary",
    url = "https://github.com/tpope/vim-commentary"
  },
  ["vim-fugitive"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/vim-fugitive",
    url = "https://github.com/tpope/vim-fugitive"
  },
  ["vim-pug"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/vim-pug",
    url = "https://github.com/digitaltoad/vim-pug"
  },
  ["vim-vsnip"] = {
    loaded = true,
    path = "/home/m/.local/share/nvim/site/pack/packer/start/vim-vsnip",
